...
"""
#run at http://www.codeskulptor.org/#user40_UlHFiw3gsm_1.py
import simpleplot
import math
import codeskulptor
...
def greedy_boss(days_in_simulation, bribe_cost_increment, plot_type = STANDARD):
    ...
    while current_day <= days_in_simulation:
        ...
        wait = math.ceil(float(bribe-savings)/salary)
        current_day += int(wait)
        savings += (salary * int(wait))
        earnings += (salary * int(wait))
